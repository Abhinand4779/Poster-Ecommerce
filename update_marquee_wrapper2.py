...
def main():
    ...
    # Regex to match the entire marquee-wrapper div
    pattern = re.compile(r'<div class="marquee-wrapper">.*?</div>', re.DOTALL)
    ...
    for file in html_files:
        ...
        if count > 0:
            with open(file, 'w', encoding='utf-8') as f:
                f.write(new_content)
            print(f"Updated marquee to have 4 spans in {file}")
